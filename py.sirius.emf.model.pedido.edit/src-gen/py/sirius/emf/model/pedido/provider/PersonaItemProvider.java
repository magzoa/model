...
/**
 * This is the item provider adapter for a {@link py.sirius.emf.model.pedido.Persona} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonaItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Persona_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Persona_id_feature", "_UI_Persona_type"),
						PedidoPackage.Literals.PERSONA__ID, true, false, false,
	...
	protected void addNombrePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Persona_nombre_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Persona_nombre_feature",
								"_UI_Persona_type"),
						PedidoPackage.Literals.PERSONA__NOMBRE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Correo feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCorreoPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Persona_correo_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Persona_correo_feature",
								"_UI_Persona_type"),
	...
	public String getText(Object object) {
		...
		return getString("_UI_Persona_type") + " " + persona.getId();
	}
